...
task.delay(4, function()
	...
	while spawned < HOTSPOT_COUNT and attempts < HOTSPOT_COUNT * 6 do
		...
		spawnedPositions[spawned + 1] = hotspotPos
		spawned += 1
	...
	for _, plr in ipairs(Players:GetPlayers()) do
		Remotes.HotspotList:FireClient(plr, spawnedPositions)
		print("[HotspotServer] Sent", #spawnedPositions, "hotspot positions to", plr.Name)
	end
end)

-- Send positions to players who join after hotspots are ready
Players.PlayerAdded:Connect(function(plr)
	if #spawnedPositions > 0 then
